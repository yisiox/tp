...
public class AddCommandTest {
    ...
    public void of_allFieldsPresent_success() {
        Person expectedPerson = new PersonBuilder(BOB).withTags(VALID_TAG_FRIEND).withAssets(VALID_ASSET_AIRCON).build();

        // whitespace only preamble
        assertParseSuccess(AddCommand::of, PREAMBLE_WHITESPACE + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + TAG_DESC_FRIEND + ASSET_DESC_AIRCON, new AddCommand(expectedPerson));


        // multiple tags - all accepted
        Person expectedPersonMultipleTags = new PersonBuilder(BOB).withTags(VALID_TAG_FRIEND, VALID_TAG_HUSBAND).withAssets()
                .build();
        ...
        Person expectedPersonMultipleAssets = new PersonBuilder(BOB).withTags().withAssets(VALID_ASSET_AIRCON, VALID_ASSET_HAMMER)
                .build();
        assertParseSuccess(AddCommand::of,
                NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
